...
| <img src="img/01-auto-fix.png" width="56" height="56"> | Co-ordination of implementation | _information: Hannes Kiivet, 663 0234, hannes.kiivet@ria.ee_ |
...
| <img src="img/01-test-tube.png" width="56" height="56"> | [Testing service](https://dhxdemo.eesti.ee/) | _correctness of implementation can be tested with [reference implementation](https://github.com/e-gov/DHX-etalon)_ |
| <img src="img/01-bug.png" width="56" height="56"> | [DHX Test suite](https://github.com/e-gov/DHX-etalon/blob/master/files/testlood.md) | _recommended minimal test set to aid DHX implementors_ (in Estonian) |
